...
public class ChatServer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        logFrame.getContentPane().add(new JScrollPane(logTextArea), "Center");
        logFrame.pack();
        ...
        /**
         * Endlosschleife und nimmt jede eingehende Verbindungsanfrage (von Clients) an.
         * Startet fuer jede Verbindung einen Thread ("Handler").
         */
    ...
    /**
     * Jeder Client besitzt seinen eigenen Handler-Thread; 
     * verwaltet die Verbindung (Socket) zum Chat-Server und uebertraegt die Nachrichten.  
     */
    private static class Handler extends Thread {
         ...
         * Anschliessend wird das Protokoll in einer Dauerschleife durchlaufen und kommuniziert mit dem Client.
         */
        public void run() {
            try {
                ...
                /**
                 * Server fordert zur Eingabe des Nicknames auf.
                 * Der Nickname darf im Chat-Raum noch nicht vergessen sein.
                 */
                while (true) {
                    ...
                    /**
                     *  Damit Threads sich nicht in die Quere kommen,
                     *  ist die Abfrage ob der Nickname vergeben ist ein kritischer Abschnitt. 
                     */
                    synchronized (users) {
                ...
                /**
                 * Nimmt die Nachrichten des Clients entgegen und antwortet bzw. verteilt 
                 * die Nachrichten entsprechend -> nur an Client selbst oder an alle Clients im Chat
                 */
                while (true) {
